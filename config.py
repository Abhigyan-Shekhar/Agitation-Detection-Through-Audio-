...
BEHAVIOUR_SCREAM_MIN_RMS_RATIO: float = 0.55
BEHAVIOUR_SCREAM_MIN_PEAK_RATIO: float = 0.70
BEHAVIOUR_SCREAM_SCORE_THRESHOLD: float = 0.60
BEHAVIOUR_SCREAM_PITCH_MEDIAN_HZ: float = 300.0
BEHAVIOUR_SCREAM_PITCH_RANGE_HZ: float = 160.0
BEHAVIOUR_SCREAM_PITCH_VARIANCE: float = 2500.0
BEHAVIOUR_SCREAM_SPECTRAL_CENTROID_HZ: float = 2500.0
BEHAVIOUR_SCREAM_SPECTRAL_ROLLOFF_HZ: float = 4500.0
BEHAVIOUR_SCREAM_ZCR: float = 0.08
BEHAVIOUR_SCREAM_ONSET_SLOPE: float = 0.002
BEHAVIOUR_SCREAM_MIN_DURATION_SEC: float = 0.25
BEHAVIOUR_SCREAM_SUSTAINED_DURATION_SEC: float = 0.80
BEHAVIOUR_SCREAM_MIN_VOICED_RATIO: float = 0.20
